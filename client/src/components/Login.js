...
const Login = ({setAuth}) => {
    ...
    <label className="text-center my-5 log">You are Logging  as Admin!</label>
        <label>Email</label>
		<input type="text" 
		name = "email"
		value ={email}
	  ...
	  />
      <label></label>
      <div class="btn-group btn-group-" role="group" ><button onClick={Student} className="btn btn-outline-info">Student</button>
